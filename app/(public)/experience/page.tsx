  ...
  const timeline = [
    {
      ...
      role: 'DevOps & Service Delivery Engineer',
      desc: 'Built and deployed VMS and Secure File Share from concept to production. Led incident response, designed DR strategies, built observability stacks, maintained ISO 27001/PCI DSS compliance. Reduced processing time by 90%, achieved 98% adoption.',
    ...
    },
    {
      ...
      role: 'Facility & DevOps Engineer (Started as NYSC Corp Member)',
      desc: 'Joined as a Youth Corper with a Facility Egineer role and grew into a full DevOps Engineer over 3 years. Managed AWS infrastructure, built CI/CD pipelines, containerised with Docker/Kubernetes, assisted in ISO 27001 & 22301 audits, led team of 6 engineers. Terraform reduced provisioning by 50%.',
