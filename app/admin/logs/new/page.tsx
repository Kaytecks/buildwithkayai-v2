      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Brief summary shown in the post grid..."
            rows={3}
        ...
        <div>
          ...
          {form.cover_image && (
            <img src={form.cover_image} alt="Cover preview" style={{ marginTop: '10px', width: '200px', height: '100px', objectFit: 'cover', border: '1px solid var(--border)' }} />
          )}
        </div>

        {/* Content */}
        <div>
          <label className="admin-label">CONTENT * (plain text or markdown)</label>
          <textarea
            className="admin-input"
            value={form.content}
